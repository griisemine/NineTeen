/*
 * ns_font5x7.h — la fonte bitmap 5 x 7, en DONNÉES SEULES.
 *
 * Elle vivait dans `ns_sprite.c`, en `static`. Elle en sort parce qu'un outil
 * hors ligne en a besoin : `tools/marqueeart` dessine les enseignes de bornes,
 * et une enseigne dessinée avec une AUTRE fonte que celle du jeu se voit tout
 * de suite — le marquee et le score d'une même borne ne se ressembleraient
 * plus.
 *
 * C'est la même règle que pour `ns_math.h` et `nstex.h` : un en-tête qui est un
 * CONTRAT entre l'outil qui écrit et le moteur qui lit vaut mieux que deux
 * copies qui divergeront. Celui-ci n'inclut que <stdint.h> — ni SDL, ni moteur.
 */
#ifndef NS_FONT5X7_H
#define NS_FONT5X7_H
 ...
 */
static const uint8_t ns_font5x7[95][5] = {
...
/* COLS/ROWS et non W/H : « NS_FONT5X7_H » est deja la garde d'inclusion de
 * ce fichier, et le compilateur le signalait a juste titre. */
#define NS_FONT5X7_COLS 5
#define NS_FONT5X7_ROWS 7
#define NS_FONT5X7_GLYPHS 95
#define NS_FONT5X7_FIRST 32     /* l'espace ; la table couvre jusqu'au tilde */
