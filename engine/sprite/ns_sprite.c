...
/* La table vit desormais dans `ns_font5x7.h` : `tools/marqueeart` en a besoin
 * pour dessiner les enseignes avec la fonte DU JEU. Voir l'en-tete. */
#define g_font5x7 ns_font5x7
